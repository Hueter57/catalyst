...
var (
	...
	TasksColumns = []*schema.Column{
		...
		{Name: "status", Type: field.TypeEnum, Enums: []string{"in_progress", "completed", "waiting"}, Default: "in_progress"},
		{Name: "importance", Type: field.TypeEnum, Enums: []string{"high", "medium", "low"}, Default: "low"},
