...
func (_q *CategoryQuery) QueryTask() *TaskQuery {
...
func (_q *CategoryQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *CategoryQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *CategoryQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *CategoryQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *CategoryQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *CategoryQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CategoryQuery) WithTask(opts ...func(*TaskQuery)) *CategoryQuery {
	query := (&TaskClient{config: _q.config}).Query()
...
func (_q *CategoryQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Category, error) {
	...
	if query := _q.withTask; query != nil {
		if err := _q.loadTask(ctx, query, nodes,
			func(n *Category) { n.Edges.Task = []*Task{} },
			func(n *Category, e *Task) { n.Edges.Task = append(n.Edges.Task, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *CategoryQuery) loadTask(ctx context.Context, query *TaskQuery, nodes []*Category, init func(*Category), assign func(*Category, *Task)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(category.TaskTable)
		s.Join(joinT).On(s.C(task.FieldID), joinT.C(category.TaskPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(category.TaskPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(category.TaskPrimaryKey[1]))
