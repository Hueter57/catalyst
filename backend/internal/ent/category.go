...
func (e CategoryEdges) TaskOrErr() ([]*Task, error) {
	if e.loadedTypes[0] {
		return e.Task, nil
	}
...
// QueryTask queries the "task" edge of the Category entity.
func (_m *Category) QueryTask() *TaskQuery {
	return NewCategoryClient(_m.config).QueryTask(_m)
}
